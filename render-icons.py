...
if __name__ == "__main__":
    parser = argparse.ArgumentParser(description='Render Comparator icons from SVG. By default, renders only PNGs that are older than their source SVG, and tries to update all possible icons.')
